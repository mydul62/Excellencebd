...
const getSingleEnrollment = catchAsync(async (req, res) => {
  const result = await EnrollmentService.getSingleEnrollmentFromDb(req.params.id);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const updateEnrollment = catchAsync(async (req, res) => {
  const result = await EnrollmentService.updateEnrollmentInDb(req.params.id, req.body);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const checkEnrollment = catchAsync(async (req, res) => {
  ...
  const result = await EnrollmentService.checkEnrollmentExists(user.id, courseId);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
