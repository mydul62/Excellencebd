...
const getSinglePhoto = catchAsync(async (req, res) => {
  const result = await PhotoGalleryService.getSinglePhotoFromDb(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const updatePhoto = catchAsync(async (req, res) => {
  const result = await PhotoGalleryService.updatePhotoInDb(req.params.id as string, req as any);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const deletePhoto = catchAsync(async (req, res) => {
  const result = await PhotoGalleryService.deletePhotoFromDb(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
